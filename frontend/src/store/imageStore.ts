...
export const useImageStore = create<ImageState>((set) => ({
  ...
  viewBeforeUrl: null,
  setFile: (file) => set({ file, isDemo: false, demoOriginalUrl: null, viewBeforeUrl: null, outputUrl: null, historyId: null }),
  setTool: (tool) => set({ tool, outputUrl: null, historyId: null }),
