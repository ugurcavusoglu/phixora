...
export default function Navbar() {
  ...
  return (
    <nav className="fixed top-0 left-0 right-0 z-50 flex items-center justify-between px-6 py-4 border-b border-[#1E1E2E] bg-[#0A0A0F]/90 backdrop-blur-md">
      ...
      {user ? (
        <div className="flex items-center gap-4">
          <Link to="/upload" className="text-sm text-[#71717A] hover:text-white transition-colors">
            Tools
          </Link>
          <Link to="/history" className="text-sm text-[#71717A] hover:text-white transition-colors">
            History
          </Link>
