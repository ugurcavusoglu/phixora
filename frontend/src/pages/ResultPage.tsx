  ...
  return (
    <div className="min-h-screen flex flex-col md:flex-row bg-bg">
      ...
      <main className="flex-1 flex flex-col items-center justify-center gap-6 p-4 md:p-8">
        ...
        {isDemo && (
          <div className="w-full max-w-full md:max-w-3xl flex flex-col sm:flex-row items-center gap-3 px-4 py-3 rounded-xl border border-sky/40 bg-sky/6 text-sm text-sky">
