    ...
    <div className="min-h-screen flex items-center justify-center px-4" style={{ background: 'var(--th-hero-grad)' }}>
      <div className="w-full max-w-sm">
        <div className="p-8 rounded-2xl border border-border bg-surface" style={{ boxShadow: '0 4px 24px var(--th-card-glow)' }}>
          <h1 className="text-2xl font-bold text-text mb-1">Log in to your account</h1>
          ...
          <button
            ...
            className="w-full py-2.5 mt-3 rounded-lg border border-sky/40 bg-sky/6 text-sky hover:bg-sky/12 transition-all duration-200 flex items-center justify-center gap-2 text-sm font-medium"
          >
